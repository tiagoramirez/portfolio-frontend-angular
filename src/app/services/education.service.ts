...
export class EducationService {
  ...
  getById (educationId: number): Observable<IEducation> {
    return this.http.get<IEducation>(environment.API_URL + '/education?id=' + String(educationId))
  }
  ...
  delete (educationId: number): Observable<IResponseMessage> {
    return this.http.delete<IResponseMessage>(environment.API_URL + '/education/delete/' + String(educationId))
  }
}
