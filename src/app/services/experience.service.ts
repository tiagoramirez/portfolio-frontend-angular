...
export class ExperienceService {
  ...
  getById (experienceId: number): Observable<IExperience> {
    return this.http.get<IExperience>(environment.API_URL + '/experience?id=' + String(experienceId))
  }
  ...
  delete (experienceId: number): Observable<IResponseMessage> {
    return this.http.delete<IResponseMessage>(environment.API_URL + '/experience/delete/' + String(experienceId))
  }
}
