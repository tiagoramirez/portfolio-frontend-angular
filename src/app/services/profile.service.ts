...
export class ProfileService {
  ...
  getById (profileId: number): Observable<IProfile> {
    return this.http.get<IProfile>(environment.API_URL + '/profile?id=' + String(profileId))
  }
  ...
  delete (profileId: number): Observable<IProfile> {
    return this.http.delete<IProfile>(environment.API_URL + '/profile/delete/' + String(profileId))
  }
}
