...
const routes: Routes = [
    ...
    { path: ':username/social-media/add', component: NewSocialMediaComponent, canActivate: [guard] },
    { path: ':username/social-media/edit/:idSm', component: EditSocialMediaComponent, canActivate: [guard] },
    { path: ':username/social-media/delete/:idSm', component: DeleteSocialMediaComponent, canActivate: [guard] },
    { path: ':username/profile/edit/:profileId', component: EditProfileComponent, canActivate: [guard] },
    { path: ':username/profile/edit/img/photo', component: EditPhotoComponent, canActivate: [guard] },
    { path: ':username/profile/edit/img/banner', component: EditBannerComponent, canActivate: [guard] },
    { path: ':username/about-me/edit/:profileId', component: EditAboutMeComponent, canActivate: [guard] },
    { path: ':username/experience/add/:profileId', component: NewExperienceComponent, canActivate: [guard] },
    { path: ':username/experience/edit/:experienceId/:profileId', component: EditExperienceComponent, canActivate: [guard] },
    { path: ':username/experience/delete/:experienceId', component: DeleteExperienceComponent, canActivate: [guard] },
    { path: ':username/education/add/:profileId', component: NewEducationComponent, canActivate: [guard] },
    { path: ':username/education/edit/:educationId/:profileId', component: EditEducationComponent, canActivate: [guard] },
    { path: ':username/education/delete/:educationId', component: DeleteEducationComponent, canActivate: [guard] },
    { path: ':username/project/add/:profileId', component: NewProjectComponent, canActivate: [guard] },
    { path: ':username/project/edit/:projectId/:profileId', component: EditProjectComponent, canActivate: [guard] },
