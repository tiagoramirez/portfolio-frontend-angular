...
export class EditPhotoComponent implements OnInit, OnDestroy {
    ...
    constructor(private readonly route: ActivatedRoute, private readonly photoService: PhotoService, private readonly router: Router, private readonly tokenService: TokenService) { }

    ngOnInit(): void {
        this.username = this.route.snapshot.params['username']
        const sub: Subscription = this.photoService.getByUsername(this.username).subscribe({
            next: (data) => {
